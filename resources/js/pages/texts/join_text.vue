                ...
                <v-col cols="12" sm="10" md="8" lg="6">
                    <v-card>
                        <v-card-text>
                            ...
                            <v-row v-if="form_data.join_to && form_data.join_to === 'word_definition'">
                                <v-col cols="12" sm="12" md="12">
                                    <v-autocomplete
                                        v-model="word_id"
                            ...
                            <v-row v-if="form_data.join_to && form_data.join_to === 'idiom_definition'">
                                <v-col cols="12" sm="12" md="12">
                                    <v-autocomplete
                                        v-model="idiom_id"
                            ...
                            <v-row v-if="form_data.join_to && form_data.join_to === 'grammer_section'">
                                <v-col cols="12" sm="12" md="12">
                                    <v-autocomplete
                                        v-model="grammer_id"
                        ...
                        <v-card-actions>
                            ...
                            <v-spacer></v-spacer>
                            <v-btn color="primary" :loading="loading" :disabled="!form_data.text_id || !form_data.join_to || !form_data.joinable_id" @click="createJoin()">
                                ثبت
                            </v-btn>
                        </v-card-actions>
                    </v-card>
